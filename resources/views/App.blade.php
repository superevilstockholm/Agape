...
<head>
    ...
    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="{{ asset('static/template_assets/plugins/fontawesome/css/fontawesome.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('static/template_assets/css/font-awesome.min.css') }}">
    <!-- Select2 CSS -->
	<link rel="stylesheet" href="{{ asset('static/template_assets/css/select2.min.css') }}">
    <!-- Datatable CSS -->
	<link rel="stylesheet" href="{{ asset('static/template_assets/css/dataTables.bootstrap4.min.css')}}">
    <!-- Chart CSS -->
...
<body class="bg-white">
    ...
    {{-- Select 2 --}}
    <script src="{{ asset('static/template_assets/js/select2.min.js') }}"></script>
    <!-- Datatable JS -->
    <script src="{{ asset('static/template_assets/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('static/template_assets/js/dataTables.bootstrap4.min.js') }}"></script>
    <!-- Theme Settings JS -->
